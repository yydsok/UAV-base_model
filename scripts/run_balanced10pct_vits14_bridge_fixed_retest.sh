#!/bin/bash
# =============================================================================
# 10% balanced 子集复测：修复 Bridge 结构后，使用固定权重重新验证
# 目标：
# 1. 验证 EMA teacher projector + 一致 prototype 更新后，Bridge 是否更稳定；
# 2. 保持主线为 DINO + MGCL + View + Bridge；
# 3. 关闭 adaptive weighting / PCGrad，减少额外变量干扰结论。
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/balanced10pct_vits14_bridge_fixed_retest_${RUN_TAG}"

echo "============================================================"
echo "  10% balanced 复测：DINO + MGCL + View + Bridge"
echo "  配置：修复 Bridge 结构后固定权重验证"
echo "============================================================"
echo "  Data: ${DATA_PATH}"
