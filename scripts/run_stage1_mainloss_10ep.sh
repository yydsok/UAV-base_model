#!/bin/bash
# =============================================================================
# DINO-MM Stage 1 Main-Loss Stabilization
#
# Goal: let DINO become the dominant optimization target before adding back
# Bridge or more aggressive multi-loss balancing.
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/stage1_mainloss_10ep_${RUN_TAG}"

echo "============================================================"
echo "  DINO-MM Stage 1 Main-Loss Stabilization"
echo "============================================================"
echo "  Data: ${DATA_PATH}"
echo "  Output: ${OUTPUT_DIR}"
echo "  Batch/GPU: ${BATCH_SIZE}"
echo "  LR arg: ${LR} (effective base LR scales with batch size)"
