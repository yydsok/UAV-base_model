#!/bin/bash
# =============================================================================
# 主损失优先对照实验：vit_small + 10% balanced + 低权重辅助损失
# 目标：验证在保留少量 MGCL/View 约束的情况下，DINO 能否突破 ~7 平台。
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/balanced10pct_vits14_mainloss_priority_${RUN_TAG}"

echo "============================================================"
echo "  主损失优先对照实验：vit_small + 10% balanced"
echo "============================================================"
echo "  Data: ${DATA_PATH}"
