#!/bin/bash
# =============================================================================
# DINO-MM 第一阶段：纯 DINO 预热
# 目标：先验证主损失单独优化时是否稳定下降。
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/stage1_dino_only_10ep_${RUN_TAG}"

echo "============================================================"
echo "  DINO-MM 第一阶段：纯 DINO 预热"
echo "============================================================"
echo "  Data: ${DATA_PATH}"
