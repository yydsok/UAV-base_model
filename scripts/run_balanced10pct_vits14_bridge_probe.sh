#!/bin/bash
# =============================================================================
# 10% balanced 子集验证：DINO + MGCL + View + Bridge
# 目的：
# 1. 在修复 crop-level modality mask 之后，重新验证 Bridge 是否能稳定接入；
# 2. 保持主干配方接近当前最优小规模设置；
# 3. 主线只保留与大视角鲁棒性直接相关的损失，避免重构目标干扰判断。
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/balanced10pct_vits14_bridge_probe_${RUN_TAG}"
