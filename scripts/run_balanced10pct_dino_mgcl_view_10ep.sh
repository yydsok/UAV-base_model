#!/bin/bash
# =============================================================================
# DINO-MM 10% balanced 子集三损失验证
# 目标：在较大子集上验证 DINO / MGCL / View 三项 loss 都能稳定下降。
# =============================================================================
...
OUTPUT_DIR="/root/autodl-tmp/train1/balanced10pct_dino_mgcl_view_10ep_${RUN_TAG}"

echo "============================================================"
echo "  DINO-MM 10% balanced 三损失验证"
echo "============================================================"
echo "  Data: ${DATA_PATH}"
