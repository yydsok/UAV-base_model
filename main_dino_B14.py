...
from models.rs_transforms import RandomChannelDrop, GaussianBlur, Solarize, RandomBrightness, RandomContrast, ToGray, RandomSensorDrop
### end of change ###
import pdb
...
def get_args_parser():
    ...
    parser.add_argument('--bands', type=str, default='B14',
