...
try:
    ...
    class VisionTransformer(nn.Module):
        def __init__(self, *args, **kwargs):
            raise ImportError(
                "timm is required for models.moco.vits. Install it with: pip install timm"
...
def vit_conv_small(**kwargs):
    # minus one ViT block
    model = VisionTransformerMoCo(
        img_size=112, in_chans=12, num_classes=19, patch_size=16, embed_dim=384, depth=11, num_heads=12, mlp_ratio=4, qkv_bias=True,
