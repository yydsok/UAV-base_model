...
def _require_lmdb():
    if lmdb is None:
        raise ImportError(
            "lmdb is required for LMDB dataset utilities. Install it with: pip install lmdb"
...
class LMDBDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return sample_s2, sample_s1, target
...
if __name__ == '__main__':
    ...
    try:
        ...
        raise ImportError(
            "cvtorchvision is required for this standalone demo. "
            "Install 'opencv-torchvision-transforms-yuzhiyang'."
        ) from exc
